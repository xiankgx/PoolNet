...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_edge_root', type=str,
                        default='')  # path for edge data
    parser.add_argument('--train_edge_list', type=str,
                        default='')  # list file for edge data
    ...
    parser.add_argument('--test_mode', type=int,
                        default=1)  # 0->edge, 1->saliency
    parser.add_argument('--sal_mode', type=str,
                        default='e')  # Test image dataset
